/**
   Solution to ACM Programming Contest 1993 Finals, Problem F, Puzzle
   http://www.karrels.org/Ed/ACM/93/prob_f.html
   Ed Karrels, February 2010
*/
...
public class acm93f {
  ...
  public static class Puzzle {
    ...
    /** Reads 5 lines of input, interpreting them as a board configuration.
        If no board configuration is provided, return false, otherwise true.*/
    public boolean read(BufferedReader in) throws IOException {
      for (int i=0; i < 5; i++) {
	String line = in.readLine();
	if (line.equals("Z")) return false;
	for (int j=0; j < 5; j++) {
    ...
    /** Transmute the configuration according to the given move.
	Returns true iff the move was legal. */
